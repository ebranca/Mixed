...
+--------------------+---------------+-----------------+---------------+---------------+
| File               |   Valid Lines |   Invalid Lines |   Empty Lines |   Total Lines |
+====================+===============+=================+===============+===============+
| marscrater_pds.csv |        384344 |               0 |             0 |        384344 |
+--------------------+---------------+-----------------+---------------+---------------+

File Statistics - DATA lines
+--------------------+----------------------+--------------------+----------------------+---------------+
| File               |   Valid HEADER Lines |   Valid DATA Lines |   Invalid DATA Lines |   Total Lines |
+====================+======================+====================+======================+===============+
| marscrater_pds.csv |                    1 |             384343 |                    0 |        384344 |
+--------------------+----------------------+--------------------+----------------------+---------------+

Data Statistics - Variables
+------------------------+----------------+------------------+----------------+
| Variable               |   Valid Values |   Missing Values |   Total Values |
+========================+================+==================+================+
| CRATER_ID              |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
| CRATER_NAME            |            987 |           383356 |         384343 |
+------------------------+----------------+------------------+----------------+
| LATITUDE_CIRCLE_IMAGE  |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
| LONGITUDE_CIRCLE_IMAGE |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
| DIAM_CIRCLE_IMAGE      |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
| DEPTH_RIMFLOOR_TOPOG   |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
| MORPHOLOGY_EJECTA_1    |          44625 |           339718 |         384343 |
+------------------------+----------------+------------------+----------------+
| MORPHOLOGY_EJECTA_2    |          19476 |           364867 |         384343 |
+------------------------+----------------+------------------+----------------+
| MORPHOLOGY_EJECTA_3    |           1293 |           383050 |         384343 |
+------------------------+----------------+------------------+----------------+
| NUMBER_LAYERS          |         384343 |                0 |         384343 |
+------------------------+----------------+------------------+----------------+
