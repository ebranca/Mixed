...
lat180 = data["LATITUDE_SOUTH_180"]
diam = data["DIAM_CIRCLE_IMAGE"]
numlay = data["NUMBER_LAYERS"]

print("Association between 'LATITUDE' and 'DIAMETER'.")
rcoeff, pval = stats.pearsonr(lat180, diam)
print("Pearson's r: %s" % (rcoeff,))
print("p-value: %s" % (pval,))
coeffd = (rcoeff ** 2)
print("Coefficient of Determination: %s (%s%%)" % (coeffd,(coeffd * 100)))
print()

print("Association between 'LATITUDE' and 'LAYERS'.")
rcoeff, pval = stats.pearsonr(lat180, numlay)
print("Pearson's r: %s" % (rcoeff,))
print("p-value: %s" % (pval,))
coeffd = (rcoeff ** 2)
print("Coefficient of Determination: %s (%s%%)" % (coeffd,(coeffd * 100)))
